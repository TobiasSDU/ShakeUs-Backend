...
exports.seedGuestsCollection = exports.testGuest2 = exports.testGuest1 = void 0;
const guest_1 = require("../../src/models/guest");
const endpoint_tests_setup_1 = require("../controllers/endpoint_tests_setup");
exports.testGuest1 = new guest_1.Guest('TestGuest1', 'TestGuest1Name');
exports.testGuest2 = new guest_1.Guest('TestGuest2', 'TestGuest2Name');
const seedGuestsCollection = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const guestSeed = [Object.assign({}, exports.testGuest1), Object.assign({}, exports.testGuest2)];
