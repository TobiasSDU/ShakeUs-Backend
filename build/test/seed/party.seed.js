...
const guest_seed_1 = require("./guest.seed");
exports.testParty1 = new party_1.Party((0, party_id_generator_1.generatePartyId)(), [guest_seed_1.testGuest2.id], guest_seed_1.testGuest2.id, [guest_seed_1.testGuest1.id], activity_pack_seed_1.testActivityPack1.id);
exports.testParty2 = new party_1.Party((0, party_id_generator_1.generatePartyId)(), ['TestHost2', 'TestHost3', guest_seed_1.testGuest3.id], 'TestHost2', [guest_seed_1.testGuest1.id, guest_seed_1.testGuest2.id], activity_pack_seed_1.testActivityPack2.id);
