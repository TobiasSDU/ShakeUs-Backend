...
describe('endpoint tests for ActivityPack routes using GET', () => {
    test('GET request to /activity-pack returns an activity pack', () => __awaiter(void 0, void 0, void 0, function* () {
        const activityPackId = activity_pack_seed_1.testActivityPack1.id;
        const res = yield endpoint_tests_setup_1.req.get('/activity-pack').send({
    ...
    test('GET request to /activity-pack with an invalid id returns 400', () => __awaiter(void 0, void 0, void 0, function* () {
